...
<head>
    ...
    <title>Insurance Application Status - CropInsure</title>
...
<body class="bg-gray-50 min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        if (isset($_SESSION['insurance_data']) && isset($_SESSION['user_farmer_id'])) {
        ...
        <div class="bg-white rounded-lg shadow-md p-8">
            <div class="bg-green-100 border-l-4 border-green-500 text-green-700 p-6 rounded-lg mb-6">
                <h2 class="text-2xl font-bold mb-4">Insurance Applied Successfully!</h2>
                <p class="mb-4">Your crop insurance application has been submitted successfully.</p>
            </div>
            ...
            <div class="bg-gray-50 rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p class="text-gray-700 mb-2"><span class="font-medium">Area:</span> <?php echo htmlspecialchars($area); ?> acres</p>
                        <p class="text-gray-700 mb-2"><span class="font-medium">Insurance Plan ID:</span> <?php echo htmlspecialchars($insurance_plan_id); ?></p>
                    </div>
                    <div>
                        <p class="text-gray-700 mb-2"><span class="font-medium">Crop ID:</span> <?php echo htmlspecialchars($crop_id); ?></p>
            ...
            <div class="mt-8 flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                <a href="<?php echo BASE_URL; ?>views/HomePage.php" 
                   class="px-6 py-3 bg-green-500 text-white rounded-md hover:bg-green-600 transition duration-300 font-medium text-center">
                    Back to Home
                </a>
                <a href="<?php echo BASE_URL; ?>views/ViewInsurancePlans.php" 
                   class="px-6 py-3 bg-yellow-500 text-white rounded-md hover:bg-yellow-600 transition duration-300 font-medium text-center">
                    View My Insurance Plans
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-8">
            <div class="bg-red-100 border-l-4 border-red-500 text-red-700 p-6 rounded-lg">
                ...
                <p class="mb-4">Application data not found. Please try applying again.</p>
                <a href="<?php echo BASE_URL; ?>views/HomePage.php" 
                   class="inline-block px-6 py-3 bg-red-500 text-white rounded-md hover:bg-red-600 transition duration-300 font-medium">
                    Back to Home
                </a>
            </div>
        </div>
